...
const EvenementsTab = dynamic(() => import('@/components/evenements/mes-evenements').then(m => ({ default: () => m.default() })), { ssr: false })
const RechercheEmploiTab = dynamic(() => import('@/components/emploi/recherche-emploi').then(m => ({ default: () => m.default() })), { ssr: false })
